  ...
  return (
    <div className="w-full">
      <div className="flex justify-end gap-2 mb-4">
        <button
          className={`px-4 py-0.5 bg-transparent ${state.selectedInterval === '60' ? 'border-[#DDC85B] text-black bg-[#DDC85B]' : 'hover:border-[#DDC85B] hover:text-black hover:bg-[#DDC85B]'} border border-[#31353F] rounded-full text-xs`}
          onClick={() => updateInterval(60, 'hours')}
        >
          1h
        </button>
        <button
          className={`px-4 py-0.5 bg-transparent ${state.selectedInterval === '180' ? 'border-[#DDC85B] text-black bg-[#DDC85B]' : 'hover:border-[#DDC85B] hover:text-black hover:bg-[#DDC85B]'} border border-[#31353F] rounded-full text-xs`}
          onClick={() => updateInterval(180, 'hours')}
        >
          3h
        </button>
        <button
          className={`px-4 py-0.5 bg-transparent ${state.selectedInterval === '1440' ? 'border-[#DDC85B] text-black bg-[#DDC85B]' : 'hover:border-[#DDC85B] hover:text-black hover:bg-[#DDC85B]'} border border-[#31353F] rounded-full text-xs`}
          onClick={() => updateInterval(1440, 'days')}
        >
          1d
        </button>
        <button
          className={`px-4 py-0.5 bg-transparent ${state.selectedInterval === '10080' ? 'border-[#DDC85B] text-black bg-[#DDC85B]' : 'hover:border-[#DDC85B] hover:text-black hover:bg-[#DDC85B]'} border border-[#31353F] rounded-full text-xs`}
          onClick={() => updateInterval(10080, 'weeks')}
        >
          1w
        </button>
        <button
          className={`px-4 py-0.5 bg-transparent ${state.selectedInterval === '43200' ? 'border-[#DDC85B] text-black bg-[#DDC85B]' : 'hover:border-[#DDC85B] hover:text-black hover:bg-[#DDC85B]'} border border-[#31353F] rounded-full text-xs`}
