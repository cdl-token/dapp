        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 justify-between">
          <div className="flex flex-col gap-3">
            <h1 className="text-3xl font-semibold">
              CDL Vote is a home of governance
            </h1>
            <span className="max-w-lg">
              CDL governance is a collective of companies, communities, and
              token holders working together for the future of the CDL protocol
            </span>
          </div>
          {/* <Image
            src="/static/coin.png"
