...
//         <div className="flex items-center justify-center gap-2 p-2 bg-custom-bg rounded-md w-72">
//           <Search size={20} />
//           <input
...
//             <tr className="border-b border-custom-bg" key={index}>
          ...
          {transactions?.length > 0 ? (
            <>
              <div className="grid md:grid-cols-2 gap-2">
                <div className="flex items-center justify-center gap-2 p-2 bg-custom-bg rounded-md w-full md:w-72">
                  <Search size={20} />
                  <input
                    className="bg-transparent w-full focus:outline-none border-none outline-none"
                    type="search"
